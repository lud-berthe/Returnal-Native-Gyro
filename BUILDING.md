...
- `dist/ReturnalGyro-1.0.3.zip`: three DLLs plus LICENSES.txt at the archive root. No INI or installer script.
- `dist/ReturnalGyro-1.0.3-SHA256.json`: hashes of the archive and payload.
