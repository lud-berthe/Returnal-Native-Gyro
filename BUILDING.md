...
- `dist/ReturnalGyro-1.0.0-Nexus.zip`: three DLLs plus installation instructions and one consolidated license file. No INI or installer script.
- `dist/ReturnalGyro-1.0.0-SHA256.json`: hashes of the archive and payload.
